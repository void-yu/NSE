...
class GraphsTest(tf.test.TestCase):
  ...
  def setUpClass(cls):
    ...
    with open(os.path.join(FLAGS.data_dir, 'vocab.txt'), 'w', encoding='utf8') as vocab_f:
      with open(os.path.join(FLAGS.data_dir, 'vocab_freq.txt'), 'w', encoding='utf8') as freq_f:
