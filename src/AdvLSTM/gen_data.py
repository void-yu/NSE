...
flags.DEFINE_string('vocab_file', 'D://Codes/NSE/data/output/word-picked', 'Path to the vocabulary file. Defaults '
                    'to FLAGS.output_dir/vocab.txt.')
flags.DEFINE_string('output_dir', 'D://Codes/NSE/data/output/tfrecord', 'Path to save tfrecords.')
...
def make_vocab_ids(vocab_filename):
  if FLAGS.output_char:
    ...
    with open(vocab_filename, encoding='utf8') as vocab_f:
